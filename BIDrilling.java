...
public class BIDrilling extends VoltProcedure {
	...
	public final SQLStmt getDrilling = new SQLStmt(
		"SELECT  USER_LOG_ACCT,ITEM_FIRST_CATE_CD,a.ITEM_AMOUNT FROM (SELECT USER_LOG_ACCT,ITEM_FIRST_CATE_CD,SUM(SALE_QTTY) SALE_QTTY,SUM(ITEM_AMOUNT) ITEM_AMOUNT FROM orders_par GROUP BY USER_LOG_ACCT, ITEM_FIRST_CATE_CD) a where a.ITEM_AMOUNT > 1000 limit 10;"
	);
